...
document.addEventListener("keydown",function(Event){makeSound(Event.key);buttonAnimate(Event.key);
});
...
function buttonAnimate(key){
    var current=document.querySelector("."+key).classList.add("pressed");
    setTimeout(function(){
